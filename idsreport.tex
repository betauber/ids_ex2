...
% "idsreport.tex"
%
% Project Report for ``Introduction to Data Science''
%
% Template derived from EMNLP 2016 (thanks!)
%==============================================================================
...
\title{Project Report Title\thanks{This is a project report part of the \textit{Introduction to Data Science} course taught by Jochen L.~Leidner at Goethe University Frankfurt in Summer Semester 2017.}}
...
Preprint servers such as arXiv.org and ACL-related workshops that do not have
published proceedings (in the ACL Anthology, or elsewhere) are not considered
...
Thanks to... anyone who helped you.

\bibliography{idsreport}
\bibliographystyle{idsreport}
